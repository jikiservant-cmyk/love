  ...
  return (
    <section className="py-20 px-4 max-w-3xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground italic">Every choice you make is a beautiful part of our story.</p>
      </div>
        ...
        {!finished ? (
          <CardContent className="p-8 sm:p-12 space-y-8">
            <div className="flex justify-between items-center text-sm font-semibold uppercase text-secondary tracking-widest mb-4">
              <span>Memory {currentStep + 1} of {questions.length}</span>
          ...
          <CardContent className="p-8 sm:p-12 text-center space-y-8 animate-in fade-in zoom-in duration-500">
            ...
            <p className="text-xl text-muted-foreground font-body">
              Every answer you chose reminds me of why I love our journey. You're the only one for me.
            </p>
            <Button 
